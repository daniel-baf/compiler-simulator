...
namespace compiler_app
{
    class extensionRegister
    {
        ...
        //--------------------------------------------- EXTENSION ----------------------------------------------------- //
        public Boolean registerExtension()
        {
            try
            {
        ...
        public Boolean registerExtensionGTE()
        {
            try
            {
                RegistryKey key1 = Registry.CurrentUser.OpenSubKey("Software", true);
                ...
                key1.CreateSubKey(".gtE");
                key1 = key1.OpenSubKey(".gtE", true);
                key1.SetValue("", "compilerSimulator.gtE");
                ...
                key2.CreateSubKey("compilerSimulator.gtE");
                key2 = key2.OpenSubKey("compilerSimulator.gtE", true);
                key2.SetValue("", "Export from Compiler Simulator");

                key2.CreateSubKey("DefaultIcon");
                key2 = key2.OpenSubKey("DefaultIcon", true);
                key2.SetValue("", Application.StartupPath + "\\Icon\\iconGTE.ico");
                ...
                key3.CreateSubKey("compilerSimulator.gtE");
                key3 = key3.OpenSubKey("compilerSimulator.gtE", true);
                key3.SetValue("", "Export from Compiler Simulator");
